        ...
        <div class="col-lg-5">
            ...
            <div class="card mt-5">
                <div class="card-body">
                    ...
                    <form action="{{ route('pema.register') }}" method="POST">
                        @csrf
            ...
            @endif
            <a href="{{ route('pema.index') }}" class="btn btn-warning text-white mt-3" style="width: 100%; font-weight: 600">Kembali ke Halaman Utama</a>
        </div>
    </div>
</div>
@endsection
