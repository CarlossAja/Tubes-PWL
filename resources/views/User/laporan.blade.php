                    ...
                    <li class="nav-item">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                ...
                                <a class="dropdown-item" href="{{ route('pekat.index') }}">Home</a>
    ...
    <div class="col-lg-8">
        <div class="laporan-top">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="dropdown">
                    <button class="btn btn-sm btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton{{ $k }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Aksi
                    </button>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $k }}">
                        <!-- Form untuk mengirim permintaan hapus -->
                        <form action="{{ route('pengaduanlaporan.destroy', $v->id_pengaduan) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button class="dropdown-item" type="submit" class="btn btn-danger mt-2" style="width: 100%" onclick="return confirm('APAKAH YAKIN?')">HAPUS</button>
                        </form>                        
                    </div>
                </div>
            </div>
